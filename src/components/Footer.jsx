...
const Footer = () => {
    return (
        <footer className="bg-gray-800 text-gray-50">
            <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400" bis_skin_checked="1">
                ...
                <div className="flex flex-col justify-center pt-6 lg:pt-0" bis_skin_checked="1">
